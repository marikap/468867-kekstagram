  ...
  window.data =(function () {
    ...
    generateRandomNumber = function (minBorder, maxBorder) {
      return Math.floor(minBorder + Math.random() * (maxBorder - minBorder + 1));
  };

    generateRandomSubarray = function (arrayElements, minNumber, maxNumber) {
    ...
    fillBlock = function (objectsArray, renderFunction, template) {
